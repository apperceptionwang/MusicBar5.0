<%@ Page Language="C#" AutoEventWireup="true" CodeFile="moreHotMusic.aspx.cs" Inherits="moreHotMusic" %>
  ...
  <tr>
    <td valign="top"><!-- InstanceBeginEditable name="Body" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr >
          <td height="28" align="left" valign="middle" class="nav"><a href="/">首页</a>->音乐排行</td>
        </tr>
        <tr>
