		...
		<tr>
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
			  ...
			  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><a href="modifyInfo.aspx" target="mainContent">修改信息</a></td>
                </tr>
                <tr>
                  <td><a href="myMusic.aspx" target="mainContent">我的音乐</a></td>
                </tr>
                <tr>
                  <td><a href="uploadMusic.aspx" target="mainContent">上载音乐</a></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                </tr>
              ...
              <td width="650">
			   <iframe id="mainContent" name="mainContent" src="modifyInfo.aspx" height="400" width="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0">			  </iframe>			  </td>
            </tr>
          </table></td>
		</tr>
      </table>
